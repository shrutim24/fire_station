...
$sender = 'TXTLCL';
$sql = "SELECT contact from firestations";
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" action="allfire.php">
                        <h2 class="form-title">SEND MESSAGE</h2>
                            <div class="dropdown">
 <center><button class="dropbtn">Fire Station</button></center> 
